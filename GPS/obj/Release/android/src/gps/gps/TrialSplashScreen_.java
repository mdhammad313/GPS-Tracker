...
public class TrialSplashScreen_ extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen_.this, md52d5b319ab200da73649ed4b77bcd1381.TraceLocationActivity.class);
